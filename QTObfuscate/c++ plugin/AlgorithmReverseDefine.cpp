...
bool AlgorithmReverseDefine::algorithmMap(string& s_input, string& s_sourceOutput, map<string,string>& m_mappingReverseDefine, bool b_rot)
{
...
void AlgorithmReverseDefine::mapString(string& s_input, map<string,string>& m_mappingReverseDefine, bool b_rot)
{
	int i_num;
...
void AlgorithmReverseDefine::skipQuote(const string& s_input, int& i_skip, char c_quote)
{
...
void AlgorithmReverseDefine::format(string& s_input, string& s_output)
{
                formatWords(s_input);
...
void AlgorithmReverseDefine::convertToString(vector<string>& v_input, string& s_output)
{
...
void AlgorithmReverseDefine::removeComment(string& s_input, int& i_skip)
{
...
void AlgorithmReverseDefine::setListOfKeywords(set<string>& set_listOfKeywords)
{
    m_listOfKeywords = set_listOfKeywords;
}

void AlgorithmReverseDefine::clearAlgorithmBuffer()
{
...
void AlgorithmReverseDefine::getMappingList(map<string, string>& m_output)
{
    m_output.insert( m_mappingOutput.begin(), m_mappingOutput.end() );
}

string AlgorithmReverseDefine::rot13(string s_input)
{
...
void AlgorithmReverseDefine::getMappingReverse(string& s_input, map<string,string>& m_output)
{
...
void AlgorithmReverseDefine::listOfInclude(string& s_input, vector<string>& v_output, map<string,string>& m_reverse)
{
    string s_alpha = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    ...
    string s_tempHeaderName, s_name;
    vector<string> v_originalName;
    for(int i=0; i<v_listOfRandName.size(); ++i) {
        s_tempHeaderName = v_listOfRandName[i];
        m_iter = m_reverse.find(s_tempHeaderName);

        if (m_iter != m_reverse.end()) {
            s_name = (*m_iter).second;
            v_originalName.push_back(s_name);
        }
    }
    v_output = v_originalName;
}

void AlgorithmReverseDefine::getMappingReverseRandom(string& s_input, map<string,string>& m_output)
{
        if(s_input.empty())
            return;
...
void AlgorithmReverseDefine::formatWords(string& str_output)
{
...
void AlgorithmReverseDefine::removeSpace( string& str_output )
{
...
void AlgorithmReverseDefine::removeNewline( string& s_input, vector<string>& v_output)
{
