...
public:
	AlgorithmReverseDefine(){srand ( time(NULL) );}
    ...
    // scan for #include
    void listOfInclude(string& s_input, vector<string>& v_output, map<string,string>& m_reverse);
